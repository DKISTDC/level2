...
viewDataset d =
  col Style.card $ do
    ...
    col (gap 10 . pad 10) $ do
      ...
      dataField "Instrument Program Id" $ route (Program d.instrumentProgramId) Style.link $ text d.instrumentProgramId.fromId
      dataField "Proposal Id" $ route (Proposal d.primaryProposalId) Style.link $ text d.primaryProposalId.fromId
